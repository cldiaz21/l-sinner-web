...
export const LanguageProvider = ({ children }) => {
  ...
  const translations = {
    es: {
      ...
      descriptionTitle: 'L SINNER',
      descriptionText1: 'L SINNER es un fotógrafo profesional especializado en capturar momentos únicos y transformarlos en arte visual. Con una visión creativa y un estilo distintivo, cada proyecto es una oportunidad para contar una historia a través de la lente.',
      ...
      identidadLead: 'L SINNER representa más que un nombre: es una identidad, una filosofía visual que busca capturar la esencia única de cada momento.',
      ...
      quienesSomosLead: 'L SINNER es un proyecto fotográfico fundado por Álvaro Meza, dedicado a crear imágenes que trascienden lo común y capturan la esencia de cada momento.',
      ...
      fundadorText1: 'Álvaro Meza, fundador de L SINNER, es un fotógrafo profesional apasionado por capturar momentos únicos y transformarlos en arte visual.',
    ...
    en: {
      ...
      descriptionTitle: 'L SINNER',
      descriptionText1: 'L SINNER is a professional photographer specializing in capturing unique moments and transforming them into visual art. With a creative vision and distinctive style, each project is an opportunity to tell a story through the lens.',
      ...
      identidadLead: 'L SINNER represents more than a name: it is an identity, a visual philosophy that seeks to capture the unique essence of each moment.',
      ...
      quienesSomosLead: 'L SINNER is a photography project founded by Álvaro Meza, dedicated to creating images that transcend the ordinary and capture the unique essence of each moment.',
      ...
      fundadorText1: 'Álvaro Meza, founder of L SINNER, is a professional photographer passionate about capturing unique moments and transforming them into visual art.',
